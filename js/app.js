 ...
 */
    ...
    (() => {
        ...
        if (document.querySelector("[data-datepicker]")) {
            ...
            if (document.querySelector(".excursion-schedule")) numCalc();
            function numCalc() {
                const calNum = document.querySelectorAll(".qs-num");
                calNum.forEach((el => {
                    el.insertAdjacentHTML("beforeend", `<span>06:00-20:00</span>`);
                }));
            }
        ...
        function initSliders() {
            if (document.querySelector(".video-hero__body")) new core(".video-hero__body", {
                modules: [ Autoplay ],
                observer: true,
                observeParents: true,
                slidesPerView: 2,
            ...
            if (document.querySelector(".popular__body")) new core(".popular__body", {
            ...
            if (document.querySelector(".slider-route__body")) new core(".slider-route__body", {
                modules: [ Navigation, Autoplay, Pagination ],
                observer: true,
                observeParents: true,
                slidesPerView: 1.4,
...
***************************************************************************** */
        ...
        if (document.querySelector(".pagination__wrapper")) {
            ...
            function pagination() {
                ...
                for (let pos = 1; pos <= totalPages; pos++) {
                    ...
                    if (totalPages >= 2 * range - 1 && truncate) if (numberTruncateLeft > 3 && numberTruncateRight < totalPages - 3 + 1) {
                        if (pos >= numberTruncateLeft && pos <= numberTruncateRight) renderTwoSide += renderPage(pos, active);
                    } else if (curPage < range && pos <= range || curPage > totalPages - range && pos >= totalPages - range + 1 || pos === totalPages || 1 === pos) render += renderPage(pos, active); else {
                        countTruncate++;
                        if (1 === countTruncate) render += dot;
                    } else render += renderPage(pos, active);
                }
                if (renderTwoSide) {
            ...
            document.querySelector(".pagination__wrapper").onclick = function(e) {
            ...
            function handleButtonLeft() {
                if (1 === valuePage.curPage) btnPrevPg.disabled = true; else btnPrevPg.disabled = false;
            }
            function handleButtonRight() {
                if (valuePage.curPage === valuePage.totalPages) btnNextPg.disabled = true; else btnNextPg.disabled = false;
            }
        }
        ...
        function documentActions(e) {
            ...
            if (targetElement.closest(".item-tours-content__favourite")) targetElement.classList.toggle("_active");
            if (document.querySelector(".excursion-schedule")) if (targetElement.closest(".qs-arrow")) numCalc();
        }
        function numCalc() {
            const calNum = document.querySelectorAll(".qs-num");
            calNum.forEach((el => {
